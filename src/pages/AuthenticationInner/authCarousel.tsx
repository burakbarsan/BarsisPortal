...
const AuthSlider = () => {
  const image1 = <img className="login-slider-img" src={Image1} />;
  const image2 = <img className="login-slider-img" src={Image2} />;

  const image3 = <img className="login-slider-img" src={Image3} />;
  const image4 = <img className="login-slider-img" src={Image4} />;
    ...
    <>
      <div className="login-slider-bg-blue">
        ...
        <div className="login-slider-text-body">
          <h1 className="login-slider-baslik">
            {i18n.t("Just Take a Step:")}
            <br /> {i18n.t("Enter Barsis World Now!")}
          </h1>
