...
export const getDialChartsData = createAsyncThunk(
  "dashboardCrm/getDialChartsData",
  async (data: any) => {
    try {
      var response;
      if (data === "today") {
...
export const getSalesChartsData = createAsyncThunk(
  "dashboardCrm/getSalesChartsData",
  async (data: any) => {
    try {
      var response;
      if (data === "oct") {
