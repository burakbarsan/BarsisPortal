...
import AirLoad from "../pages/Air/AirLoad";
import AirList from "../pages/Air/AirList";
import CustomReport from "../pages/CustomReport/CustomReport";
import GlobalLCLFinanceReport from "pages/CustomReport/GlobalLCLFinanceReport";
import TeuReport from "pages/CustomReport/TeuReport";
import GlobalFinanceReport from "pages/CustomReport/GlobalFinanceReport";
import KPIPerformance from "pages/CustomReport/KPIPerformance";
import TruckerList from "pages/CustomReport/TruckerList";
import ShipmentDoneList from "pages/CustomReport/ShipmentDoneList";
import UsaFileProfit from "pages/CustomReport/UsaFileProfit";
import AirShipmentList from "pages/CustomReport/AirShipmentList";
import PoaBondSummary from "pages/CustomReport/PoaBondSummary";
import InvoiceBenchmarkReport from "pages/CustomReport/InvoiceBenchmarkReport";
import UsaWarehouseCostReport from "pages/CustomReport/UsaWarehouseCostReport";

const authProtectedRoutes= [


  { path: "/index", component: <DashboardEcommerce /> },
  { path: "/airLoad", component:<AirLoad/>},
  { path: "/airList", component:<AirList/>},
  { path: "/customReport", component:<CustomReport/>},
  { path: "/globalLcl", component:<GlobalLCLFinanceReport/>},
  { path: "/teuReports", component:<TeuReport/>},
  { path: "/globalFinance", component:<GlobalFinanceReport/>},
  { path: "/kpiReport", component:<KPIPerformance/>},
  { path: "/truckerList", component:<TruckerList/>},
  { path: "/shipmentDone", component:<ShipmentDoneList/>},
  { path: "/usaFileProfit", component:<UsaFileProfit/>},
  { path: "/airShipmentList", component:<AirShipmentList/>},
  { path: "/poaBondSummary", component:<PoaBondSummary/>},
  { path: "/invoiceBencmark", component:<InvoiceBenchmarkReport/>},
  { path: "/usaWarehouse", component:<UsaWarehouseCostReport/>},
