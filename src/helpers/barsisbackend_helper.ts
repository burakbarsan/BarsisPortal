...
// Login Method
export const postApiLogin = (data: any) => api.create(url.POST_LOGIN, data);
...
export const getLastWeekDeviceData = () =>
  api.get(url.GET_LASTWEEKDEVICE_DATA, "");
...
export const getEuroPortfolioData = () =>
  api.get(url.GET_EUROPORTFOLIO_DATA, "");
...
export const getAllMarketplaceData = () =>
  api.get(url.GET_ALLMARKETPLACE_DATA, "");
...
export const getJobApplicationList = () =>
  api.get(url.GET_APPLICATION_LIST, "");
